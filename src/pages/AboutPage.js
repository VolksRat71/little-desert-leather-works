    ...
    <div className="pt-24 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className={`bg-${colorPalette.primary.base} text-${colorPalette.text.light} px-6 py-12 rounded-t shadow`}>
          <h1 className="text-4xl font-bold mb-2 text-center">About Our Artisan</h1>
        ...
        <div className={`bg-${colorPalette.ui.background} p-8 rounded-b shadow mb-8`}>
          <div className="flex flex-col md:flex-row gap-8 mb-8">
            ...
            <div className="md:w-2/3">
              <h2 className={`text-3xl font-bold mb-2 text-${colorPalette.text.primary}`}>{artisan.name}</h2>
              ...
              <div className="mt-6">
                <h3 className={`text-xl font-semibold mb-2 text-${colorPalette.text.primary}`}>My Craft Philosophy</h3>
          ...
          <div className="border-t border-gray-200 pt-8">
            <h3 className={`text-xl font-semibold mb-4 text-${colorPalette.text.primary}`}>Specialized Skills</h3>
        ...
        {/* Workshop Images */}
        <div className="mb-12">
          <h2 className={`text-2xl font-bold mb-6 text-${colorPalette.text.primary}`}>The Workshop</h2>
